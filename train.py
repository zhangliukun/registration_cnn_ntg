...
if __name__ == '__main__':
    ...
    train_voc2011 = False    # 根据论文在VOC2011的训练集训练
    multi_gpu = True   #
    ...
    if train_voc2011:
        ...
        vis_env = "DNN_train_voc2011_20r"
        args.training_image_path = '/home/zlk/datasets/vocdata/VOC_train_2011/VOCdevkit/VOC2011/JPEGImages'
        load_checkpoint_path = "/home/zlk/project/registration_cnn_ntg/trained_weight/voc2011/checkpoint_voc2011_20r_NTG_resnet101.pth.tar"
        output_checkpoint_path = "/home/zlk/project/registration_cnn_ntg/trained_weight/voc2011/checkpoint_voc2011_20r_NTG_resnet101.pth.tar"
    ...
    start_train(args.training_image_path,args.test_image_path,load_checkpoint_path,output_checkpoint_path,vis_env,paper_affine_generator = paper_affine_generator,
                random_seed=10004,log_interval=log_interval,multi_gpu =multi_gpu, use_cuda=use_cuda)
